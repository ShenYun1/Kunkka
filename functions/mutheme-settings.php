...
class Mutheme_settings {
    ...
    public function help() {
        ...
        ?>
        <div class="wrap">
            <h1>欢迎使用<?php echo MUTHEME_NAME . ' ' . MUTHEME_VERSION; ?>_local_shenyun</h1>
            ...
            <div class="changelog">
                ...
                <div class="feature-section under-the-hood one-col">
                    <div class="col">
                        <h3>关于</h3>
                        <p>本主题以[牧风]<a href="https://mufeng.me/" target="_blank">https://mufeng.me/</a>大神的Kunkka 1.06为基础改进而来，经Alatelee二次修改<a href="http://agatelee.cn" target="_blank">http://agatelee.cn</a>，又经神韵博客<a href="https://51shenyun.cn" target="_blank">https://51shenyun.cn</a>三次修改。</p>
						<p>wordpress主题太多 在众多主题中 我偏偏喜欢上了这款 它简洁 没有花里胡哨 但是由于版本太老 且牧风大佬也早已停止更细 在使用中出现的BUG不仅奇穷千奇百怪！！ 为此我在alatelee的修改版基础上 再次修改 修复了一些BUG 并优化了很多</p>
						<p>本应有熊掌号改造来 但是由于技术有限 不会在主题设置里添加选项 如有需求可以看这篇文章<a href="https://51shenyun.cn/json_ld/" target="_blank">JSON-LD改造及熊掌号搜索出图改造教程</a></p>
						<p>Github项目/更新日志：<a href="https://github.com/ShenYun1/Kunkka" target="_blank">https://github.com/ShenYun1/Kunkka</a></p>
                    </div>
                </div>
            </div>
        </div>
